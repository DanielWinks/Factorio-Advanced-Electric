function engine_vertical_animation_layers_secondary()
    return {
        {
...
function engine_horizontal_animation_layers_secondary()
    return {
        {
...
function engine_vertical_animation_layers_primary()
    return {
        {
        filename = "__base__/graphics/entity/steam-engine/steam-engine-V.png",
        width = 112,
...
function engine_horizontal_animation_layers_primary()
    return {
        {
        filename = "__base__/graphics/entity/steam-engine/steam-engine-H.png",
        width = 176,
...
data.raw["generator"]["steam-engine"].horizontal_animation.layers = engine_horizontal_animation_layers_secondary()
data.raw["generator"]["steam-engine"].vertical_animation.layers = engine_vertical_animation_layers_secondary()
...
steam_engine_mk2.horizontal_animation.layers = engine_horizontal_animation_layers_secondary()
steam_engine_mk2.vertical_animation.layers = engine_vertical_animation_layers_secondary()
...
steam_engine_mk3.horizontal_animation.layers = engine_horizontal_animation_layers_secondary()
steam_engine_mk3.vertical_animation.layers = engine_vertical_animation_layers_secondary()
...
steam_engine_mk4.horizontal_animation.layers = engine_horizontal_animation_layers_secondary()
steam_engine_mk4.vertical_animation.layers = engine_vertical_animation_layers_secondary()
...
primary_load_engine.horizontal_animation.layers = engine_horizontal_animation_layers_primary()
primary_load_engine.vertical_animation.layers = engine_vertical_animation_layers_primary()
...
primary_load_steam_engine_mk2.horizontal_animation.layers = engine_horizontal_animation_layers_primary()
primary_load_steam_engine_mk2.vertical_animation.layers = engine_vertical_animation_layers_primary()
...
primary_load_steam_steam_engine_mk3.horizontal_animation.layers = engine_horizontal_animation_layers_primary()
...
primary_load_steam_steam_engine_mk4.horizontal_animation.layers = engine_horizontal_animation_layers_primary()
primary_load_steam_steam_engine_mk4.vertical_animation.layers = engine_vertical_animation_layers_primary()
