function turbine_vertical_animation_layers_secondary()
    return {
        {
...
function turbine_horizontal_animation_layers_secondary()
    return {
        {
...
function turbine_vertical_animation_layers_primary()
      return {
        {
          filename = "__base__/graphics/entity/steam-turbine/steam-turbine-V.png",
          width = 108,
...
function turbine_horizontal_animation_layers_primary()
    return {
        {
          filename = "__base__/graphics/entity/steam-turbine/steam-turbine-H.png",
          width = 160,
...
data.raw["generator"]["steam-turbine"].horizontal_animation.layers = turbine_horizontal_animation_layers_secondary()
data.raw["generator"]["steam-turbine"].vertical_animation.layers = turbine_vertical_animation_layers_secondary()
...
steam_turbine_mk2.horizontal_animation.layers = turbine_horizontal_animation_layers_secondary()
steam_turbine_mk2.vertical_animation.layers = turbine_vertical_animation_layers_secondary()
...
primary_load_turbine.horizontal_animation.layers = turbine_horizontal_animation_layers_primary()
primary_load_turbine.vertical_animation.layers = turbine_vertical_animation_layers_primary()
...
primary_load_steam_turbine_mk2.horizontal_animation.layers = turbine_horizontal_animation_layers_primary()
primary_load_steam_turbine_mk2.vertical_animation.layers = turbine_vertical_animation_layers_primary()
